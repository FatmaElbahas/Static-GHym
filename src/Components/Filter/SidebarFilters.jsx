        ...
        >
          ...
          <div className="d-flex flex-column align-items-center justify-content-center py-5">
            ...
            <div className="filters-loading">
              ...
              <h6 className="text-center mb-3" style={{ color: "#038FAD", fontWeight: "500" }}>
                جاري تحميل الفلاتر...
              </h6>
    ...
    <aside className="col-lg-3 col-md-4" style={{ marginTop: '1.5rem' }}>
      <style>{`
        ...
        .sidebar-filters .btn-primary:hover {
          background-color: #027a8a !important;
          border-color: #027a8a !important;
      ...
      {/* معلومات البيانات المتاحة */}
        ...
        <div className="form-group mb-3">
          <label className="form-label d-flex align-items-center mb-2 main-color">
            ...
            المدينة
            {citiesLoading && (
              <FontAwesomeIcon icon={faSpinner} className="fa-spin ms-2" style={{ fontSize: '0.8rem', color: '#038FAD' }} />
            )}
          </label>
          {citiesLoading ? (
            <div className="form-select rounded-pill border-0 bg-light d-flex align-items-center justify-content-center position-relative" style={{ height: '38px' }}>
              <div className="d-flex align-items-center">
                <div className="spinner-border spinner-border-sm me-2" role="status" style={{ width: '1rem', height: '1rem', color: '#038FAD' }}>
                  <span className="visually-hidden">Loading...</span>
                </div>
